...
{
    private static readonly string AutostartPath =
        $"{Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)}/.config/autostart";

    private static readonly string AutostartDesktopFilePath = $"{AutostartPath}/BambiHeavy.desktop";
